// Package main vsebuje vstopno točko aplikacije.
// Uporablja paket redovalnica za demonstracijo funkcij za upravljanje ocen.
package main
...
func main() {
	...
	// Inicializacija vzorčnih študentov
